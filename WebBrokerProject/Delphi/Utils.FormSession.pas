...
//    ASession.DataVars.Values[SessionKey] := ARequest.ContentFields.ValueFromIndex[I];
  end;
  
  // Set timestamp for cleanup
  ASession.DataVars.AddPair(FORM_DATA_PREFIX + AFormName + FORM_TIMESTAMP_SUFFIX, DateTimeToStr(Now));
//  ASession.DataVars.Values[FORM_DATA_PREFIX + AFormName + FORM_TIMESTAMP_SUFFIX] := DateTimeToStr(Now);
end;
